...
from src.unet3d.se import ChannelSELayer3D, ChannelSpatialSELayer3D, SpatialSELayer3D
        ...
        if upsample:
            if basic_module == DoubleConv:
                if is3d:
                    ...
                    self.upsampling = TransposeConvUpsampling(in_channels=in_channels, out_channels=in_channels // 2,
                                                          kernel_size=2, scale_factor=2, is3d=False)
                # concat joining
...
class TransposeConvUpsampling(AbstractUpsampling):
    ...
    def __init__(self, in_channels=None, out_channels=None, kernel_size=3, scale_factor=(2, 2, 2), is3d=True):
        if is3d:
